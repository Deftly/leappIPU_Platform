...
file_path = 'upgradeResultsHr.json'
data = pd.read_json(file_path)

# Extract relevant data
# buckets = data['aggregations']['failed_upgrade_jobs_by_half_hour']['buckets']
buckets = data['aggregations']['failed_upgrade_jobs_by_hour']['buckets']
